...
export async function chatWithCoach(
  ...
  const systemPrompt = `你是个带过不少业余跑者的教练，正陪一个想认真训练的朋友聊天。目标是把他的情况摸清楚，好排出真正适合他的周课表。说话别端着，像平时聊天那样自然，一次只问一两句，别把一堆问题一次全抛出来。
...
[{ "op": "set", "day": 数字(1=周一…6=周六,0=周日), "type": "easy|tempo|interval|long|recovery|cross|rest", "km": 公里数或null, "pace": "配速如5:30/km"或null, "note": "一句话说明，如改成轻松跑8公里" }, { "op": "clear", "day": 数字 }, { "op": "goal", "text": "新的本周目标" }]
